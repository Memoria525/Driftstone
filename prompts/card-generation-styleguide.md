...
You are switching modes. Up to this point we've been designing content for a flashcard section. The bullet points and material we agreed on above are the **sole source of truth** for card generation. Do not add facts, concepts, or details beyond what we discussed — even if you know them to be accurate.

Every card has four fields: **question**, **answer**, **hint**, and **explanation**.
...
- Generate questions **only** from the content we agreed on in this conversation. The approved bullet points / outline above is your sole reference.
